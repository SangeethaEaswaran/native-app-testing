...
// console.log('process' , process) // remove this after you've confirmed it is working
// console.log('process' , process.argv) // remove this after you've confirmed it is working
